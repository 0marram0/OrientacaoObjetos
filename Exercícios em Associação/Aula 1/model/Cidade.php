...
class Cidade {
    ...
    {
        $dados = "A cidade de " . $this->nome . ", localizada no estado " . $this->estado->getNome() . " (" . $this->estado->getSigla(). ")" . ", possui " . $this->qtdHabitantes . " habitantes e uma altitude de " . $this->altitude . " metros." . "\n \n";   
        return $dados;
    }
